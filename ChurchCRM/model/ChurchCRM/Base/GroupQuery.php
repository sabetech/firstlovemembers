 ...
 *
 * @method     \ChurchCRM\ListOptionQuery|\ChurchCRM\Person2group2roleP2g2rQuery|\ChurchCRM\EventTypesQuery|\ChurchCRM\EventQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class GroupQuery extends ModelCriteria
{
     ...
     *
     * @param \ChurchCRM\ListOption $listOption The related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByListOption($listOption, $comparison = null)
    {
        if ($listOption instanceof \ChurchCRM\ListOption) {
            ...
            throw new PropelException('filterByListOption() only accepts arguments of type \ChurchCRM\ListOption');
        }
    }
    ...
    /**
     * Filter the query by a related \ChurchCRM\EventTypes object
     *
     * @param \ChurchCRM\EventTypes|ObjectCollection $eventTypes the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildGroupQuery The current query, for fluid interface
     */
    ...
    {
        if ($eventTypes instanceof \ChurchCRM\EventTypes) {
            return $this
            ...
            throw new PropelException('filterByEventTypes() only accepts arguments of type \ChurchCRM\EventTypes or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ChurchCRM\EventTypesQuery A secondary query class using the current class as primary query
     */
    public function useEventTypesQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinEventTypes($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'EventTypes', '\ChurchCRM\EventTypesQuery');
    }
