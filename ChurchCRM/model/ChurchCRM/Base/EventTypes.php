...
abstract class EventTypes implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ChurchCRM\\Map\\EventTypesTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\Base\EventTypes object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\ChurchCRM\EventTypes The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ChurchCRM\\EventTypes'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ChurchCRM\EventTypes
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ChurchCRM\EventTypes The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ChurchCRM\EventTypes (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ChurchCRM\EventTypes Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aGroup === null && ($this->type_grpid !== null)) {
